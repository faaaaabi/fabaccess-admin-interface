...
export class AccessDeviceService {
    ...
    constructor() {
        this.dummyAccessDevices = [
            ...
            {id: this.makeid(32), name: 'Access Device 4', apiKey: this.makeid(64)},
            {id: this.makeid(32), name: 'Access Device 5', apiKey: this.makeid(64)},
            {id: this.makeid(32), name: 'Access Device 6', apiKey: this.makeid(64)},
            {id: this.makeid(32), name: 'Access Device 7', apiKey: this.makeid(64)},
            {id: this.makeid(32), name: 'Access Device 8', apiKey: this.makeid(64)},
    ...
    async addDevice(deviceName: string) {
        ...
        storedAccessDevices.push({id: generatedId, name: deviceName, apiKey});
        await localForage.setItem('accessDevices', storedAccessDevices);
    }

    async editDevice(accessDeviceId: string, accessDeviceName: string) {
        const storedAccessDevices: AccessDevice[] = await this.getAllAccessDevices();
